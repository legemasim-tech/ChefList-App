...
LANG_CONFIG = {
    ...
    "Español": {
        ...
        "legal_note": "⚠️ **Nota:** Esta aplicación utiliza IA. La IA puede cometer errores; verifique los tiempos.", 
    ...
    "Français": {
        ...
        "legal_note": "⚠️ **Note:** Cette application utilise l'IA. L'IA peut faire des erreurs - veuillez vérifier.", 
    ...
    "Italiano": {
        ...
        "legal_note": "⚠️ **Nota:** Questa app utilizza l'IA. L'IA può sbagliare: verifica i tempi.", 
    ...
    "Português": {
        ...
        "legal_note": "⚠️ **Nota:** Este aplicativo usa IA. A IA pode cometer erros – verifique.", 
    ...
    "Nederlands": {
        ...
        "legal_note": "⚠️ **Opmerking:** Deze app maakt gebruik van AI. AI kan fouten maken.", 
    ...
    "Polski": {
        ...
        "legal_privacy_title": "🛡️ Ochrona danych", "legal_privacy_body": "Nie przechowujemy danych osobowych. Przetwarzanie jest szyfrowane.", 
        "legal_note": "⚠️ **Uwaga:** Ta aplikacja korzysta z AI. AI może popełniać błędy.", 
    ...
    "Türkçe": {
        ...
        "legal_note": "⚠️ **Not:** Bu uygulama yapay zeka kullanır. Yapay zeka hata yapabilir.", 
    ...
    "日本語": {
        ...
        "legal_note": "⚠️ **注意:** AIは間違いを犯す可能性があります。内容を確認してください。", 
        "admin_label": "🔑 管理者"
    }
}
