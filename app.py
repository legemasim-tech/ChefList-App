...
LANG_CONFIG = {
    "English": {
        ...
        "ui_create": "Create Recipe ✨", "ui_wait": "Calculating for {0} servings...Just a chef's second! 👨‍🍳", "ui_ready": "Ready!",
    ...
    "Deutsch": {
        ...
        "ui_create": "Rezept erstellen ✨", "ui_wait": "Berechne für {0} Portionen...der Chefkoch rechnet kurz nach.👨‍🍳", "ui_ready": "Bereit!",
    ...
    "Español": {
        ...
        "ui_create": "Crear ✨", "ui_wait": "Calculando {0} raciones... ¡Un momento, por favor! 🥘", "ui_ready": "¡Listo!",
    ...
    "Français": {
        ...
        "ui_create": "Créer ✨", "ui_wait": "Calcul pour {0} portions... Un instant, s'il vous plaît ! 🍳", "ui_ready": "Prêt!",
    ...
    "Italiano": {
        ...
        "ui_create": "Crea ✨", "ui_wait": "Calcolo per {0} porzioni... Solo un attimo! 🍝", "ui_ready": "Pronto!",
    ...
    "Nederlands": {
        ...
        "ui_create": "Maken ✨", "ui_wait": "Berekenen voor {0} porties... Een ogenblik geduld! ⏲️", "ui_ready": "Klaar!",
    ...
    "Polski": {
        ...
        "ui_create": "Utwórz ✨", "ui_wait": "Obliczanie dla {0} porcji... Jeszcze chwila! 🥟", "ui_ready": "Gotowe!",
    ...
    "Türkçe": {
        ...
        "ui_create": "Oluştur ✨", "ui_wait": "{0} porsiyon için hesaplanıyor... Çok kısa bir süre! 🥘", "ui_ready": "Hazır!",
    ...
    "日本語": {
        ...
        "ui_create": "作成 ✨", "ui_wait": "{0}人分を計算中... 少々お待ちください 🍱", "ui_ready": "完了！",
